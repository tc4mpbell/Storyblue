		...
		*/
		...
		protected function getFontStyleString (  bold : Boolean, italic : Boolean, family: String ):String
		{
			...
			if ( bold && italic ) 
				...
				font += "-Oblique";
			else if(family == "Times-Roman" || font=="Times")
				font = "Times-Roman";//TC restore -Roman, if such existed.
			
			if(font.indexOf("Times")>=0)
				font = font.replace("Oblique", "Italic");
		...
		{	
			...
			{	
				...
				{	
					if(children[i].name() == "FONT") trace("parseTags: " + children[i].attributes());
